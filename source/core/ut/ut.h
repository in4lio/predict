...
/*  ut.h was generated by yup.py (yupp) 1.0c2
    out of ut.yu-h 
 *//**
 *  \file  ut.h (ut.yu-h)
 *  \brief  Unit testing.
...
#define UT_VAR( decl ) \
	decl
#define UT_VAR_INIT( decl, ... ) \
	decl = __VA_ARGS__

#ifdef __cplusplus
#define UT_VAR_C( decl ) \
	extern "C" decl; decl
#define UT_VAR_C_INIT( decl, ... ) \
 ...
 */
UT_VAR_C( uint32_t ( *ut_get_time_callback )( void ) );

/**
 *  \brief Event handler of testing stage starting (callback).
 *  \param t Stage of testing.
 */
UT_VAR_C( void ( *ut_started_callback )( int t ) );
 ...
 */
UT_VAR_C( void ( *ut_finished_callback )( int t, bool result ) );

/**
 *  \brief Lock common data access (callback).
 */
UT_VAR_C( void ( *ut_lock_callback )( void ) );

/**
 *  \brief Unlock common data access (callback).
 */
UT_VAR_C( void ( *ut_unlock_callback )( void ) );

...
/*  error.h was generated by yup.py (yupp) 1.0c2
    out of error.yu-h 
 *//**
...
#define ERROR_VAR( decl ) \
	decl
#define ERROR_VAR_INIT( decl, ... ) \
	decl = __VA_ARGS__

#ifdef __cplusplus
#define ERROR_VAR_C( decl ) \
	extern "C" decl; decl
#define ERROR_VAR_C_INIT( decl, ... ) \
...
#undef ERROR_EXT_C
#undef ERROR_VAR
#undef ERROR_VAR_INIT
#undef ERROR_VAR_C
#undef ERROR_VAR_C_INIT
#undef ERROR_INL
#endif

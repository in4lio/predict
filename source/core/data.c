...
/*  data.c was generated by yup.py (yupp) 0.8b2
    out of data.yu-c at 2015-03-19 13:58
 *//**
...
/**
 *  \brief Descriptor of state vector variable.
 */
struct DATA_DESCRY {
	/**  Variable name */
	const char *name;
...
/**
 *  \brief Structure of state vector.
 */
struct DATA_VECTOR {
	word error;
	byte _ut_byte;
 ...
 *  \brief State vector.
 */
static struct DATA_VECTOR data_vector;

/**
 *  \brief Descriptor of state vector.
 */
static const struct DATA_DESCRY data_descry[] = {
			
	{ "error", type_WORD, 1, &data_vector.error, ( void *) string_word_h },
		
	{ "_ut_byte", type_BYTE, 1, &data_vector._ut_byte, ( void *) string_byte },
		
	{ "_ut_word", type_WORD, 1, &data_vector._ut_word, ( void *) string_word_h },
		
	{ "_ut_array", type_DWORD, 4, &data_vector._ut_array, ( void *) string_dword_h },
	{ "_ut_array_1", type_DWORD, 3, data_vector._ut_array + 1, ( void *) string_dword_h },
	{ "_ut_array_2", type_DWORD, 2, data_vector._ut_array + 2, ( void *) string_dword_h },
	{ "_ut_array_3", type_DWORD, 1, data_vector._ut_array + 3, ( void *) string_dword_h },
		
	{ "_ut_float", type_FLOAT, 1, &data_vector._ut_float, ( void *) string_float },

	{ "_ut_vote"  , type_BYTE, 4, data_vector._ut_vote    , ( void *) string_byte },
	{ "_ut_vote_1", type_BYTE, 3, data_vector._ut_vote + 1, ( void *) string_byte },
	{ "_ut_vote_2", type_BYTE, 2, data_vector._ut_vote + 2, ( void *) string_byte },
	{ "_ut_vote_3", type_BYTE, 1, data_vector._ut_vote + 3, ( void *) string_byte },
	{ "_ut_vote__VALID"  , type_BYTE, 4, data_vector._ut_vote__VALID    , string_byte },
	{ "_ut_vote__VALID_1", type_BYTE, 3, data_vector._ut_vote__VALID + 1, string_byte },
	{ "_ut_vote__VALID_2", type_BYTE, 2, data_vector._ut_vote__VALID + 2, string_byte },
	{ "_ut_vote__VALID_3", type_BYTE, 1, data_vector._ut_vote__VALID + 3, string_byte },

...
/*  ut.c was generated by yup.py (yupp) 0.8b2
    out of ut.yu-c at 2015-03-06 14:47
 *//**
 *  \file  ut.c (ut.yu-c)
 *  \brief  Unit testing.
...
{
	printf( __CRLF__ );
	printf( "%.*s", console_col_count, ________ );
	printf( __CRLF__ __CRLF__"%*s", ( console_col_count + strlen( __PASSED__ )) / 2, ( result ) ? __PASSED__ : __FAILED__ );

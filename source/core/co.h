...
/*  co.h was generated by yup.py (yupp) 1.0b6
    out of co.yu-h 
 *//**
 *  \file  co.h (co.yu-h)
...
CO_EXT_C_INIT( co_t co_receive_char, NULL );
/** "receive_char" coroutine alive flag. */
CO_EXT_C_INIT( int receive_char_alive, CO_SKIP );
...
CO_EXT_C_INIT( co_t co_console, NULL );
/** "console" coroutine alive flag. */
CO_EXT_C_INIT( int console_alive, CO_SKIP );
/** "console" coroutine. */
...
CO_EXT_C_INIT( co_t co_console_cyclic, NULL );
/** "console_cyclic" coroutine alive flag. */
CO_EXT_C_INIT( int console_cyclic_alive, CO_SKIP );
...
CO_EXT_C_INIT( co_t co_ut_2, NULL );
/** "ut_2" coroutine alive flag. */
CO_EXT_C_INIT( int ut_2_alive, CO_SKIP );
/** "ut_2" coroutine. */

...
/*  data-vote.h was generated by yup.py (yupp) 1.0c2
...
#define DATA_VOTE_VAR( decl ) \
	decl
#define DATA_VOTE_VAR_INIT( decl, ... ) \
	decl = __VA_ARGS__

#ifdef __cplusplus
#define DATA_VOTE_VAR_C( decl ) \
	extern "C" decl; decl
#define DATA_VOTE_VAR_C_INIT( decl, ... ) \
...
#undef DATA_VOTE_EXT
#undef DATA_VOTE_INIT
#undef DATA_VOTE_EXT_C
#undef DATA_VOTE_VAR
#undef DATA_VOTE_VAR_INIT
#undef DATA_VOTE_VAR_C
#undef DATA_VOTE_VAR_C_INIT
#undef DATA_VOTE_INL
#endif
